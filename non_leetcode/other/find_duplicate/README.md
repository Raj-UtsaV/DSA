...
The information needed for find a duplicate element can be summarized by values already seen. A hash-based lookup avoids repeatedly scanning earlier input.
