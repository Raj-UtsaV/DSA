# Prefix and Postfix Expression Conversions
...
The unresolved items in prefix and postfix expression conversions must be handled in a specific last-in or first-in order. The stack or queue stores exactly those pending items until they can be resolved.
