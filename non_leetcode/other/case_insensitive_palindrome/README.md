...
The relevant positions for case-insensitive palindrome can be advanced monotonically. Two pointers avoid restarting a scan and, where applicable, update the input in place.
