...
The information needed for maximum occurring character can be summarized by values already seen. A hash-based lookup avoids repeatedly scanning earlier input.
