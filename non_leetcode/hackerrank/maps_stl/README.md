...
The information needed for maps-stl can be summarized by values already seen. A hash-based lookup avoids repeatedly scanning earlier input.
...
- Time: O(q) average across q hash-map queries
- Space: O(q)
