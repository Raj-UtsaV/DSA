...
The relevant positions for minimum platforms can be advanced monotonically. Two pointers avoid restarting a scan and, where applicable, update the input in place.
