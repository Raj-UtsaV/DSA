...
The linked structure in delete all occurrences of a key in a doubly linked list can be handled by coordinating a small number of pointers. Their relative movement exposes the required position or permits local rewiring without an auxiliary collection.
