...
The valid answers for generate binary strings without consecutive ones form a decision tree. The implementation builds one candidate at a time and abandons a branch as soon as it violates a constraint.
