...
A locally optimal choice for n meetings in one room leaves the greatest flexibility for the remaining input. Ordering the candidates makes that safe choice available at each step.
