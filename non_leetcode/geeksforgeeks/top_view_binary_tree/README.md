...
The input for top view of binary tree represents connectivity between graph elements. Grouping reachable or unioned elements turns the requested result into a component-level calculation.
