...
The information needed for intersection of two arrays ii can be summarized by values already seen. A hash-based lookup avoids repeatedly scanning earlier input.
