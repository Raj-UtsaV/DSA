...
The candidate values for find first and last position of element in sorted array have an ordered or monotonic structure. Binary search can discard half of the remaining range after each comparison or feasibility check.
