...
A locally optimal choice for non-overlapping intervals leaves the greatest flexibility for the remaining input. Ordering the candidates makes that safe choice available at each step.
