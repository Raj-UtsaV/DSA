...
The candidate values for find the smallest divisor given a threshold have an ordered or monotonic structure. Binary search can discard half of the remaining range after each comparison or feasibility check.
