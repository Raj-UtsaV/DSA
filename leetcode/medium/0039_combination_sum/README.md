...
The valid answers for combination sum form a decision tree. The implementation builds one candidate at a time and abandons a branch as soon as it violates a constraint.
...
- Time: Exponential in the target and candidate count
