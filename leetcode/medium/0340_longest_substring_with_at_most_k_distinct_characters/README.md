...
Valid candidates for longest substring with at most k distinct characters occupy contiguous ranges. A moving window reuses the previous range's state instead of recomputing counts for every start position.
