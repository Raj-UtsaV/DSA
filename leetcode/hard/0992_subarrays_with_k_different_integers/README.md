...
Valid candidates for subarrays with k different integers occupy contiguous ranges. A moving window reuses the previous range's state instead of recomputing counts for every start position.
